...
const Navbar = () => {
    ...
    const { getCartCount, navigate, token, setToken, setCartItems, setShowSearch, wishlist } = useContext(ShopContext);
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to="/wishlist" className='relative'>
                    ...
                    {wishlist && wishlist.length > 0 && (
                        <p className='absolute right-[-5px] bottom-[-5px] text-center leading-4 bg-red-600 text-white aspect-square rounded-full text-[8px] w-4'>{wishlist.length}</p>
                    )}
                </Link>
